<template>
  <header class="flex justify-between align-middle p-3 md:px-5">
    <NuxtLink to="/">
      <div class="flex gap-2 items-center">
        <svg class="w-12 h-12 md:w-14 md:h-14" xmlns="http://www.w3.org/2000/svg" fill="#ff3535" viewBox="0 0 100 100">
          <path
